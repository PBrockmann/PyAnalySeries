...
It is designed as a modern continuation of the **[AnalySeries](https://github.com/PaleoIPSL/AnalySeries)**, the original application on MacOS, aiming to reproduce its core functionalities within a more robust and portable Python environment.
